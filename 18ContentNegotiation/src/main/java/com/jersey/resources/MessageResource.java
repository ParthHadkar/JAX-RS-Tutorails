...
public class MessageResource 
{
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addMessageJson (Message message,@Context UriInfo uriInfo)//Message
	{
	...
	@Produces(MediaType.TEXT_XML)
	public Response addMessageXml (Message message,@Context UriInfo uriInfo)//Message
	{
		//return messageServices.addMessage(message);
		Message newMessage = messageServices.addMessage(message);
		String messageId = String.valueOf(newMessage.getId());
